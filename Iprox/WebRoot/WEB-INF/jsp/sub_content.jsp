...
<head>
    ...
    <link REL="stylesheet" TYPE="text/css" HREF="/Iprox/html/css/lorikeet.css">
</head>
<body>
<!--[if lte IE 7]>
            ...
            <div>
                ...
                <div class="sub_cont clearfix" style="display:none;">
                    ...
                    <div id="tabModule2" class="tabModule clearfix">
                        ...
                        <div>
                            <div id="lorikeet" style="width:900px;"></div>
                ...
                <div class="sub_cont clearfix" style="display:none;">
                    ...
                    <div id="tabModule3" class="tabModule clearfix">
                        <div class="tabswitch" id="lorikeet2">
                            <a href="#" class="active">Spectrum</a>
                            <a href="#">Fragmentation table</a>
                            <a href="#">Protein Sequence</a>
                        </div>
                ...
                <div class="sub_cont" style="display:none;"></div>
...
<script src="/Iprox/html/js/spectrum/jquery-ui.min.js"></script>
<script src="/Iprox/html/js/spectrum/jquery.flot.js"></script>
<script src="/Iprox/html/js/spectrum/jquery.flot.selection.js"></script>
<script src="/Iprox/html/js/spectrum/specview.js"></script>
<script src="/Iprox/html/js/spectrum/peptide.js"></script>
<script src="/Iprox/html/js/spectrum/aminoacid.js"></script>
<script src="/Iprox/html/js/spectrum/ion.js"></script>
